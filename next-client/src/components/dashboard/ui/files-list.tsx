      ...
      {files.map((file) => (
        <div className="flex flex-col gap-2 relative" key={file.id}>
          ...
          <div className="flex justify-between items-center gap-2">
            <p
              className="flex-1 text-sm font-bold text-ellipsis whitespace-nowrap overflow-hidden block"
              ...
              <AlertDialog>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="">
                    <DropdownMenuGroup>
                      <DropdownMenuItem
                        onClick={() => handleCopyLink(file.viewUrl)}
                      ...
                      <DropdownMenuItem
                        onClick={() => handleOpenLink(file.viewUrl)}
                        className="cursor-pointer"
                      >
                        <Eye />
                        View
                      ...
                      <DropdownMenuItem
                        onClick={() => handleOpenLink(file.downloadUrl)}
                        className="cursor-pointer"
                      >
                        <Download />
                        Download
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                      onClick={() => handleToggleExpiration(file)}
                      className="cursor-pointer"
                    >
                      {file.expiresAt ? (
                        <>
          ...
          <div className="flex justify-between items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">{getFileExpiresAtLabel(file)}</p>
          </div>
        </div>
      ))}
    </div>
