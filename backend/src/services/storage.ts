...
export interface StorageProvider {
  ...
  getFile(filePath: string, localPath: string): Promise<Buffer | Readable>;
}

export const getUniqueFilename = (originalPath: string): string => {
...
export const convertImageToAvif = async (
  filePath: string,
...
class LocalStorageProvider implements StorageProvider {
  ...
  async getFile(filePath: string, localPath: string): Promise<Buffer | Readable> {
